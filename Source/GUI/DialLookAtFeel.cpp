...
#include "DialLookAtFeel.h"

namespace dial
{

    dial::CustomDial::CustomDial()
    {
    }

    void dial::CustomDial::drawRotarySlider
    (
        juce::Graphics& g,
    ...
    void dial::CustomDial::drawLabel(juce::Graphics& g, juce::Label& label)
    {
...
#pragma mark Dial Just Label
    dial::CustomDialLabel::CustomDialLabel()
    {
    }

    void dial::CustomDialLabel::drawLabel(juce::Graphics& g, juce::Label& label)
    {
        g.fillAll(label.findColour(juce::Label::backgroundColourId));
