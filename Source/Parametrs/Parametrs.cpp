...
const juce::String typeId              = "filterType";
const juce::String typeName            = "Filter Type";

// Spatial processing
const juce::String delayTimeID         = "delay";
const juce::String delayTimeName       = "Delay";

const juce::String balanceID           = "balance";
const juce::String balanceName         = "Balance";

const juce::String widthID             = "width";
const juce::String widthName           = "Width";
